...
<head>
    ...
    <title>Dashboard|Assessment Tool  </title>
    ...
    <nav class="navbar navbar-default title1">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="Javascript:void(0)"><b>Assessment Tool</b></a>
            </div>
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li <?php echo''; ?> > <a href="login.php"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Log out</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                if(@$_GET['q']== 2) 
                {
                    $q=mysqli_query($conn,"SELECT * FROM users  ORDER BY id DESC " )or die('Error223');
                ...
                <?php 
                    if(@$_GET['q']==1) 
                    {
                        ...
                        while($row = mysqli_fetch_array($result)) 
                        {
                            ...
                            echo '<tr><td><center>'.$c++.'</center></td><td><center>'.$email.'</center></td><td><center><a title="Delete User" href="update.php?demail='.$email.'"><b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></a></center></td></tr>';
                        }
                        $c=0;
                        echo '</table></div></div>';
                    }
